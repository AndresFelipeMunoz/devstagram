...
@section('content')
    <div class="container mx-auto md:flex">
        <div class="md:w-1/2">
            <img src="{{ asset('uploads').'/'.$post->imagen}}" alt="Imagen del post {{$post->titulo}}" class="max-w-full sm:max-w-[90%] h-auto">
            <div class="p-3">
                <p>0 Likes</p>
            </div>
            <div>
        ...
        <div class="md:w-1/2 p-5">
            <div class="shadow bg-white p-5 mb-5">
                @auth
                <p class="text-xl dont-bold text-center mb-4" >Agregar un Nuevo Comentario</p>
